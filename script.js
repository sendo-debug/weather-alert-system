...
function renderRiskMarker(data) {
    ...
    /*
       Bigger risk = bigger marker.
       Same visual idea as the Streamlit/PyDeck map.
    */
...
async function initRiskMap() {
    ...
    try {
        ...
        /*
           Automatically refresh AI risk every 10 minutes.
        */
        if (riskRefreshTimer) {
        ...
        /*
           Leaflet sometimes needs a resize calculation after
           replacing an iframe dynamically.
        */
        setTimeout(() => {
            if (riskMap) {
...
function populateCurrentWeather(data, placeName) {
    ...
    /*
       IMPORTANT:
       The old Google Maps iframe update has intentionally
       been removed.

       The map is now the fixed 7-point Bareilly AI risk map.
    */
}
...
function getLocationAndWeather() {
    ...
    navigator.geolocation.getCurrentPosition(
        ...
        async (position) => {
            ...
            /*
               Current location is still used for:
               - hero weather
               - hourly forecast
               - daily forecast
               - current-location AI card
               - history lookup

               The map itself stays fixed to the
               7-point Bareilly grid.
            */
...
/*
   Start the Bareilly risk map independently of geolocation.
   This means the map still works even if the user denies
   browser location permission.
*/
initRiskMap();

/*
   Start normal current-location weather.
*/
